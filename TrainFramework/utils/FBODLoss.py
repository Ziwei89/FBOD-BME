...
class LossFunc(nn.Module): #
    def __init__(self,num_classes, model_input_size=(672,384), default_inner_proportion=0.7, default_guassion_value=0.3, scale=80., stride=2, cuda=True,gettargets=False, assign_method=None):
        super(LossFunc, self).__init__()
        self.num_classes = num_classes
        self.model_input_size = model_input_size
        self.scale = scale
         #(model_input_size, num_classes=2, stride=2)
        self.get_targets = getTargets(model_input_size, num_classes=num_classes, default_inner_proportion=default_inner_proportion, default_guassion_value=default_guassion_value, scale=scale, stride=stride, cuda=cuda, assign_method=assign_method)
        self.cuda = cuda
